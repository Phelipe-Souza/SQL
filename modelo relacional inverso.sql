...
-- -----------------------------------------------------
-- Table `relacional_db`.`carrro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `relacional_db`.`carrro` (
  `id_carrro` INT NOT NULL,
  `marca` VARCHAR(45) NULL,
  `ano` VARCHAR(45) NULL,
  `pessoa_id_pessoa` INT NOT NULL,
  PRIMARY KEY (`id_carrro`, `pessoa_id_pessoa`),
  CONSTRAINT `fk_carrro_pessoa`
